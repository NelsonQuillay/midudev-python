...
specific_date = datetime(2025, 9, 26, 12, 20, 0)
...
# formato:
import locale
# Configurar la localización de Argetina
...
print(f"Una hora más tarde: {one_hour_later}")
...
date1 = datetime.now()
date2 = datetime(1988, 9, 26, 12, 00, 0)
